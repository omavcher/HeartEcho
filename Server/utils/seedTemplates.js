...
const defaults = [
  ...
  <div class="email-preview">
    ...
    <div class="eh-hero">
      ...
      <a href="https://heartecho.in/pricing" class="eh-cta">Unlock Premium →</a>
    </div>
    <div class="eh-body">
      <p>Hey {{first_name}},</p>
      ...
      <p style="text-align:center"><a href="https://heartecho.in/pricing" class="eh-cta">Choose Your Plan →</a></p>
    </div>
    <div class="eh-footer">
      <p>HeartEcho · heartecho.in · <a href="#">Unsubscribe</a></p>
    </div>
  ...
  <div class="email-preview">
    ...
    <div class="eh-hero">
      ...
      <a href="https://heartecho.in/pricing" class="eh-cta">Continue for ₹99 →</a>
    </div>
    <div class="eh-body">
      <p>Hey {{first_name}},</p>
      ...
      <p style="text-align:center"><a href="https://heartecho.in/pricing" class="eh-cta">Lock In ₹99 Offer →</a></p>
    </div>
    <div class="eh-footer">
      <p>HeartEcho · heartecho.in · <a href="#">Unsubscribe</a></p>
    </div>
  ...
  <div class="email-preview">
    ...
    <div class="eh-body">
      ...
      <div class="eh-divider"></div>
      <p style="text-align:center"><a href="https://heartecho.in/pricing" class="eh-cta">Upgrade to Premium →</a></p>
