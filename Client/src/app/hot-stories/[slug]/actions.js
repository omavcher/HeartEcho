...
export default function StoryPageClient({ initialStory, initialRelatedStories, slug }) {
  ...
  const transformedStory = {
    ...
    content_en: story.content_en || { story: story.description || '# Story', cliffhanger: '', teaserChat: 'Hi', cta: 'Start Chat' },
    content_hi: story.content_hi || { story: story.description || '# कहानी', cliffhanger: '', teaserChat: 'हाय', cta: 'चैट शुरू करें' },
