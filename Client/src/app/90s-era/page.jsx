...
export const metadata = {
  title: { absolute: '90s Letter Duniya — Retro Indian Letters | HeartEcho' },
  ...
  alternates: {
    canonical: 'https://heartecho.in/90s-era',
  },
  openGraph: {
    title: '90s Letter Duniya — Retro Indian Letters | HeartEcho',
