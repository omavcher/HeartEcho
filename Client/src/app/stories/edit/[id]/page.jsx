...
const EditStoryPage = () => {
  ...
  const categories = [
    'Housewife', 'Corporate', 'Tech', 'Academic', 'Traditional',
    'Artist', 'Conservative', 'Business', 'Royal', 'Beach',
    'Professional', 'Romantic', 'Adventure', 'Mystery', 'Fantasy'
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`${api.Url}/story/${storyId}`, storyData);
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await axios.delete(`${api.Url}/story/${storyId}`);
