...
const GeneratedAi = ({ generatedData }) => {
    ...
    const handleSendMessage = async () => {
        try {
            ...
            const aiFriendId = aiResponse.data.friend._id; // Get AI Friend ID
            navigate(`/chatbox?chatId=${aiFriendId}`); // Pass AI Friend ID in URL
            } else {
            }
        } catch (error) {
        ...
        <div className="chat-containergenrated">
            ...
            <div className="chat-headerinergenrated">
                <div className="profile-pic-ainergenrated">
                    {generatedData.Image ? (
                        <img src={generatedData.Image} alt="Character Avatar" />
                    ) : (
