...
function ProfileLists({handleSettindSelection , onBackSBTNSelect}) {
  ...
  const [twoFactor, setTwoFactor] = useState(userData?.twofactor);
    ...
    const getUserData = async () => {
      try {
        ...
        if (res.data) {
          ...
          console.log(res.data.twofactor); // Correctly logs fetched data
        } 
      } catch (error) {
  ...
  const handleToggle2F = async () => {
    ...
    setTwoFactor(newStatus); // Update UI instantly
    ...
    try {
      ...
      setTwoFactor(!newStatus); // Revert UI if request fails
    }
  };
  ...
  return (
    ...
    <section className='main-setting-section'>
      ...
      <div className='main-setting-list-q3'   onClick={() => { handleSettindSelection(2); onBackSBTNSelect(false); }}>
         ...
         <svg className='main-setting-lisvg' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M16 12L10 18V6L16 12Z"></path></svg>
      </div>

      <div className='main-setting-list-q3' onClick={() => {handleSettindSelection(3); onBackSBTNSelect(false);}}>
         <div className='main-list-info-cont'>
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="12" height="12" fill="currentColor"><path d="M11 1V2H7C5.34315 2 4 3.34315 4 5V8C4 10.7614 6.23858 13 9 13H15C17.7614 13 20 10.7614 20 8V5C20 3.34315 18.6569 2 17 2H13V1H11ZM6 5C6 4.44772 6.44772 4 7 4H17C17.5523 4 18 4.44772 18 5V8C18 9.65685 16.6569 11 15 11H9C7.34315 11 6 9.65685 6 8V5ZM9.5 9C10.3284 9 11 8.32843 11 7.5C11 6.67157 10.3284 6 9.5 6C8.67157 6 8 6.67157 8 7.5C8 8.32843 8.67157 9 9.5 9ZM14.5 9C15.3284 9 16 8.32843 16 7.5C16 6.67157 15.3284 6 14.5 6C13.6716 6 13 6.67157 13 7.5C13 8.32843 13.6716 9 14.5 9ZM6 22C6 18.6863 8.68629 16 12 16C15.3137 16 18 18.6863 18 22H20C20 17.5817 16.4183 14 12 14C7.58172 14 4 17.5817 4 22H6Z"></path></svg>                   <span>
          <h3>AI Assistants</h3>
          <p>Customize automation.</p>
         </span>
         </div>
         <svg className='main-setting-lisvg' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M16 12L10 18V6L16 12Z"></path></svg>
      </div>
      ...
      <div className='main-setting-list-q3' onClick={() => {handleSettindSelection(5); onBackSBTNSelect(false);}}>
         <div className='main-list-info-cont'>
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M13 4.05493C17.5 4.55237 21 8.36745 21 13V22H3V13C3 8.36745 6.50005 4.55237 11 4.05493V1H13V4.05493ZM19 20V13C19 9.13401 15.866 6 12 6C8.13401 6 5 9.13401 5 13V20H19ZM12 18C9.23858 18 7 15.7614 7 13C7 10.2386 9.23858 8 12 8C14.7614 8 17 10.2386 17 13C17 15.7614 14.7614 18 12 18ZM12 16C13.6569 16 15 14.6569 15 13C15 11.3431 13.6569 10 12 10C10.3431 10 9 11.3431 9 13C9 14.6569 10.3431 16 12 16ZM12 14C11.4477 14 11 13.5523 11 13C11 12.4477 11.4477 12 12 12C12.5523 12 13 12.4477 13 13C13 13.5523 12.5523 14 12 14Z"></path></svg>                   <span>
          <h3>AI Training</h3>
          <p>Improve AI responses.</p>
         </span>
         </div>
         <svg className='main-setting-lisvg' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M16 12L10 18V6L16 12Z"></path></svg>
      </div>
      ...
      <div className='main-setting-list-q3' onClick={() => {handleSettindSelection(6); onBackSBTNSelect(false);}}>
         <div className='main-list-info-cont'>
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M20 22H4C3.44772 22 3 21.5523 3 21V3C3 2.44772 3.44772 2 4 2H20C20.5523 2 21 2.44772 21 3V21C21 21.5523 20.5523 22 20 22ZM19 20V4H5V20H19ZM8 9H16V11H8V9ZM8 13H16V15H8V13Z"></path></svg>
                            <span>
...
{showOtpInput && (
  <div className="overlay-delete-confirm">
    <div className="popup">
      ...
      <button style={{marginTop:'1rem'}} className="otp-btn-singr" onClick={handleVerifyOtp} disabled={deleteing}>
      ...
      <div className='main-setting-list-q3' >
         <div className='main-list-info-cont' onClick={() => {handleSettindSelection(9); onBackSBTNSelect(false);}}>
         ...
         <label class="toggle-switch">
          <input  type="checkbox" checked={userData?.termsAccepted}></input>
