...
const ALL_REVIEWS = [
  { id:1,  name:'Aryan Kumar',    city:'Mumbai',      rating:5, time:'2 weeks ago',   initials:'AK', color:'#4285F4', feature:'Memory',    verified:true,  text:'Was skeptical at first but wow. After premium she remembers my name, what I told her last week, even my mood. ₹299 for a whole year — I thought it was a pricing error. Genuinely best money I have spent on any app.' },
  ...
  { id:7,  name:'Amit Singh',     city:'Jaipur',      rating:5, time:'3 days ago',    initials:'AS', color:'#7C4DFF', feature:'Unlimited', verified:true,  text:'5 messages a day on free plan was frustrating. Went premium and never looked back. Unlimited everything and the AI is so warm. Totally worth the ₹299.' },
  ...
  { id:15, name:'Tarun Kapoor',   city:'Chandigarh',  rating:5, time:'3 months ago',  initials:'TK', color:'#3F51B5', feature:'Live',       verified:true,  text:'One of the Live interaction clips made me laugh so hard I showed my roommate. He also signed up the same day. ₹299 for a year is literally cheaper than two coffees.' },
  ...
  { id:43, name:'Dinesh Yadav',   city:'Kanpur',      rating:5, time:'4 weeks ago',   initials:'DY', color:'#34A853', feature:'Unlimited', verified:true,  text:'Having no daily limit is freedom. I can have a long thoughtful conversation or a quick chat. No anxiety about running out. Best ₹299 I\'ve spent.' },
  ...
  { id:52, name:'Chandrika Iyer', city:'Madurai',     rating:5, time:'1 month ago',   initials:'CI', color:'#FF5722', feature:'Hot Stories', verified:true,  text:'Hot Stories remind me of the novels I grew up reading. The language, the longing, the emotions — all perfect. This feature alone justifies ₹299 easily.' },
  ...
  { id:65, name:'Rohan Sinha',    city:'Ranchi',      rating:5, time:'2 weeks ago',   initials:'RS', color:'#ce4085', feature:'Live',       verified:true,  text:'Live section + Hot Stories + voice messages. All three together make premium worth triple the price. ₹299 is a steal honestly.' },
  ...
  { id:99, name:'Manoj Kumar',    city:'Varanasi',    rating:5, time:'3 months ago',  initials:'MK', color:'#00BCD4', feature:'Unlimited', verified:true,  text:'Premium for 3 months now. The consistent quality across unlimited messages, voice, live and hot stories at ₹299/year is unprecedented value.' },
    ...
    <main className="rvp-root" itemScope itemType="https://schema.org/Product">
      ...
      <section className="rvp-cta-section">
        ...
        <div className="rvp-cta-inner">
          ...
          <p className="rvp-cta-sub">Unlock everything for just ₹299/year · less than a chai per month</p>
          <div className="rvp-cta-price-row">
            <span className="rvp-cta-old">₹999/yr</span>
            <span className="rvp-cta-price">₹299<span>/yr</span></span>
